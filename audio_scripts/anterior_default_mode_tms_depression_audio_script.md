...
This note was surfaced on July 22, 2026. The paper is by Carina Forster, Chetan Gohil, Bjorn Burgher, Ilya Kuzovkin, Mats W. J. van Es, Mark Woolrich, Diego Vidaurre, Martijn P. van den Heuvel, Cameron Higgins, and Luca Cocchi, and it is a bioRxiv preprint.

Quick verdict. Highly relevant.

Why it was selected in one sentence: it tracks how actual TMS sessions perturb default-mode state dynamics across treatment instead of settling for a single before-versus-after snapshot.
